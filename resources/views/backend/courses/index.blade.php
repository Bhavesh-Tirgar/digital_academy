...
<div class="container text-center">
    ...
    <div class="d-flex flex-column align-items-center">
        ...
        <div class="custom-card">
            <a href="{{ route('courses.uploadMaterial', ['id' => 1, 'plan' => 'basic']) }}" 
               class="glow-btn glow-btn-warning">BASIC</a>
        </div>

        <!-- Standard Plan Card -->
        <div class="custom-card">
            <a href="{{ route('courses.uploadMaterial', ['id' => 2, 'plan' => 'standard']) }}" 
               class="glow-btn glow-btn-primary">STANDARD</a>
        </div>

        <!-- Premium Plan Card -->
        <div class="custom-card">
            <a href="{{ route('courses.uploadMaterial', ['id' => 3, 'plan' => 'premium']) }}" 
