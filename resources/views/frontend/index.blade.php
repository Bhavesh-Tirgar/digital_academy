    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <p class="text-primary">{{ $category->content}}</p>
            </div>
        </div>
        @endforeach
    </div>
...
<section class="pricing" id="pricing">
    ...
    <div class="box-container">
        <div class="box">
            ...
            <a href="{{ url('/select-plan/basic') }}" class="btn1">Choose Basic</a>
        </div>
        ...
        <div class="box">
            ...
            <a href="{{ url('/select-plan/standard') }}" class="btn1">Choose Standard</a>
        </div>
        ...
        <div class="box">
            ...
            <a href="{{ url('/select-plan/premium') }}" class="btn1">Choose Premium</a>
        </div>
    </div>
</section>
        ...
        <div class="reviews">
            @foreach($reviews as $review)
                <div class="review-card border p-3 mb-2">
                    ...
                    <p>{{ $review->review }}</p> {{-- Fixed column name --}}
