...
<div class="container">
    <div class="header-wrapper">
        <h2 class="text-center">Subjects for <?php echo e(ucfirst($plan)); ?> Plan</h2>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
                ...
                <a href="<?php echo e(url('/frontend/materials/' . $subject->id . '/' . $plan)); ?>">View Materials</a>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\govind\Desktop\project\digital_academy\resources\views/frontend/subjects.blade.php ENDPATH**/ ?>