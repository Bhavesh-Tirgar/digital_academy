...
<div class="container">
    <h2>Materials for <?php echo e($course->name); ?> (<?php echo e(ucfirst($plan)); ?> Plan)</h2>
        ...
        <div class="material-row">
            <?php $__currentLoopData = $materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $material): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="material-card">
                    <h4><?php echo e(ucfirst($material->type)); ?>: <?php echo e($material->title ?? 'Untitled'); ?></h4>
                    ...
                    <?php if($material->type === 'video'): ?>
                        <div class="video-container">
                            ...
                            <div class="video-info"><?php echo e($material->title ?? 'Untitled'); ?></div>
                        </div>
                    <?php elseif($material->type === 'pdf'): ?>
                        <a href="<?php echo e(asset('storage/' . $material->file_path)); ?>" class="view-btn" target="_blank">
                    ...
                    <a href="<?php echo e(asset('storage/' . $material->file_path)); ?>" class="download-btn" download>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\govind\Desktop\project\digital_academy\resources\views/frontend/materials.blade.php ENDPATH**/ ?>